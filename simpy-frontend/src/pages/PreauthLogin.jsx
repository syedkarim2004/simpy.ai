  ...
  return (
    <div className="min-h-screen bg-[#F7F9F8] flex items-center justify-center p-6 login-card">
      ...
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-3xl p-10 shadow-xl relative overflow-hidden">
        <div className="absolute top-0 right-0 w-32 h-32 -mr-8 -mt-8 bg-blue-600/5 rounded-full blur-2xl" />
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-3xl font-black text-navy mb-2 tracking-tight">Pre-Auth Portal</h2>
          <p className="text-slate-500 font-medium mb-8">Secure Login</p>
          ...
          <form className="w-full space-y-4" onSubmit={handleLogin}>
            <div className="space-y-2 text-left">
              ...
              <input 
                ...
                className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-all font-medium"
              />
            </div>
            ...
            <button 
              type="submit"
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-black py-4 rounded-xl transition-all shadow-lg shadow-blue-600/30 flex items-center justify-center gap-2 mt-4"
            >
