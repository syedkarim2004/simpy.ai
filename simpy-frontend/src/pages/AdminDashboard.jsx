...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F9F8] flex flex-col items-center justify-center p-6 text-center">
      <div className="w-20 h-20 bg-slate-800/10 rounded-full flex items-center justify-center mb-8 animate-bounce">
        <Hammer className="w-10 h-10 text-slate-800" />
      </div>
      
      <h1 className="text-4xl font-black text-navy mb-4 tracking-tight">Admin Portal</h1>
      <p className="text-slate-500 font-medium text-lg mb-12 max-w-md">
        Dashboard under construction. System administration and enterprise controls are being provisioned.
      </p>
